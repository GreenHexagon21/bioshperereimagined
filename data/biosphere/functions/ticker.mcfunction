...
execute if score tick timer matches 30 run execute as @e[name="33x33_sur_pro",sort=random,limit=1] in minecraft:overworld at @s run function biosphere:probe/surface/33x33
# execute if score tick timer matches 100 run execute as @e[name="25x25_sub_pro",sort=random,limit=1] in minecraft:overworld at @s run function biosphere:probe/subsurface/25x25
# execute if score tick timer matches 120 run execute as @e[name="25x25_sur_pro",sort=random,limit=1] in minecraft:overworld at @s run function biosphere:probe/surface/25x25
