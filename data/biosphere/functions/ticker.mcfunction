...
execute if score tick timer matches 2 run execute as @e[name="47x47_sur_pro",sort=random,limit=1] in minecraft:overworld at @s run function biosphere:probe/subsurface/47x47
...
execute if score tick timer matches 80 run forceload remove all
execute if score tick timer matches 81.. run scoreboard players set tick timer 0