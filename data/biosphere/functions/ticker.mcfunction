...
execute if score tick timer matches 2 run execute as @e[name="17_sur",sort=random,limit=1] in minecraft:overworld at @s run function biosphere:probe/subsurface/47x47
execute if score tick timer matches 10 run execute as @e[name="17_sub",sort=random,limit=1] in minecraft:overworld at @s run function biosphere:probe/subsurface/33x33
