...
execute at @s if dimension minecraft:overworld in minecraft:overworld run setblock ~ ~ ~ structure_block[mode=load]{name:"biosphere:17x17_negative",posX:0,posY:0,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
