...
execute as @e[name="33x33_sub_pro",sort=random,limit=1] if entity @s[y=64,dy=300] at @s positioned over ocean_floor in minecraft:overworld run tp @s ~ ~-40 ~
execute as @e[name="33x33_sub_pro",sort=random,limit=1] if entity @s[y=64,dy=-100] at @s in minecraft:overworld unless block ~ ~ ~ water run tp @s ~ ~ ~
execute as @e[name="33x33_sub_pro",sort=random,limit=1] if entity @s[y=64,dy=-100] at @s positioned over ocean_floor in minecraft:overworld run tp @s ~ ~-40 ~
