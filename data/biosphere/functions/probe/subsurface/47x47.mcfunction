...
execute at @s if dimension minecraft:overworld in minecraft:overworld run setblock ~-23 ~-25 ~-23 structure_block[mode=save]{name:"biosphere:47x47_temp_sub",posX:0,posY:1,posZ:0,sizeX:47,sizeY:47,sizeZ:47,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:0b} replace
